...
public class DropDownTestClass {
	...
	public static void main(String[] args) {
		...
		System.out.println(monthList); // this fucntion ill return the collection of the list. because we are printing  the array list directly. 
