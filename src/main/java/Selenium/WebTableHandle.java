...
public class WebTableHandle {
	...
	public static void main(String[] args) {
		...
		for(int rowNum=2; rowNum<=rowCount+1; rowNum++) {
			String actualXpath = beforeXpath + rowNum + afterXpath; // we are creating xpath on numbers of rows
			System.out.println(actualXpath); 
			String value = driver.findElement(By.xpath(actualXpath)).getText();
			System.out.println(value); // this will print all values (names and xpath of them)
		}
